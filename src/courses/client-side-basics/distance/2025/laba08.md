...
Напишите код, который запускает эксперимент. Сформируйте отчет в html-файле.
...
Результаты оформляются в виде html-файла:
...
Код в репозитории для выполнения замеров, отчет в html со снимками экранов и выводами.
