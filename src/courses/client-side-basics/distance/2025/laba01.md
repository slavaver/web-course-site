...
1. Принять задание на [gitverse lab](https://gitverse.ru/smartclass?invite=2a9a7bc6-b59f-11f1-92d3-4e40dbff4363).
1. Склонировать созданный репозиторий.
1. Создать на ветке main файл README.md с группой и ФИО, сделать коммит и отправить его на gitverse.
1. Решить предложенные задачи используя JS.
1. Подключить решения к index.html.
1. Сохранить результат, сделать коммит и отправить его на gitverse.
