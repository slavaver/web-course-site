...
Проверьте что вы находитесь на ветке main и ESLint настроен.

Решите задачи, разместив элементы интерфейса для них в отдельных секциях с соответствующими подзаголовками.
...
Зафиксируйте результаты работы с помощью системы контроля версий git и отправьте в репозиторий на gitverse.
