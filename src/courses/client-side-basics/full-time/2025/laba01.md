...
1. Создать на ветке main файл README.md с группой и ФИО, сделать коммит и отправить его на github.
1. Затем создать ветку lab1 и переключиться на нее и далее работать на ней.
...
1. Сохранить результат, сделать коммит и отправить его на github.
