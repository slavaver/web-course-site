...
Давайте посмотрим, когда нужно использовать тег `<p> ` — это абзац в HTML. Абзац — это отдельный кусочек текста. Найдем на макете: 
